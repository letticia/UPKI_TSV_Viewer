...
- **長文データの表示とダウンロード**: 「CSR」や「発行・更新申請-証明書」といったデータ量の多いセルは、「内容を表示」ボタンによるポップアップ（モーダル）表示ができるほか、自動整形されたPEM形式ファイル（.csr や .cer）として、適切なファイル名で直接ダウンロードすることが可能です（「発行・更新申請-証明書」列は初期状態で非表示になっています）。
